...
/**
 * Classe PageAjouterJuin
 * @author ldatchi
 *
 */
public class PageAjouterJuin extends JFrame implements ActionListener{
	/**
	 * Attributs privés de la classe PageAjouterJuin
	 */
	//Attributs privés
	//Panel
	private JPanel panelPageAjouterJuin;
	...
	public PageAjouterJuin() {
	    ...
	    /**
	     * Instanciation de mes panels "panelPageAjouterJuin" et "panelMessage"
	     */
	    //Instanciation des panels
	    this.panelPageAjouterJuin = new JPanel();
	    this.panelMessage = new JPanel();
	    this.panelChamps = new JPanel();
	    this.panelBouton = new JPanel();

	    /**
	     * Mise en place des background des panels "panelPageAjouterJuin" et "panelMessage"
	     */
	    //Background des panels
	    this.panelPageAjouterJuin.setBackground(Color.white);
	    this.panelMessage.setBackground(Color.black);
	    
	    /**
	     * Mise en place des dispositions des panels "panelPageAjouterJuin" et "panelMessage"
	     */
	    //Disposition des panels
	    this.panelPageAjouterJuin.setLayout(new BorderLayout());
	    ...
	    this.panelPageAjouterJuin.add(panelMessage, BorderLayout.NORTH);
	    this.panelPageAjouterJuin.add(panelChamps, BorderLayout.CENTER);
	    this.panelPageAjouterJuin.add(panelBouton, BorderLayout.SOUTH);
	    ...
	    //Toujours à la fin
  		...
  		this.getContentPane().add(panelPageAjouterJuin);
  		this.setVisible(true);
	}
	
	public JPanel getMonPanelPageAjouterJuin() {
    	return panelPageAjouterJuin;
    }
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnValider) {
            java.sql.Date uneDateDebut = (java.sql.Date) PageAjouterJuin.this.datePicker1.getModel().getValue();
            java.sql.Date uneDateFin = (java.sql.Date) PageAjouterJuin.this.datePicker2.getModel().getValue();
            ...
            boolean rep = Modele.AjouterAffectationJuin(uneDateDebut, uneDateFin, uneAffectation, uneAutreAbsence);
            if(rep) {
