 ...
 *
 */
public class PageAjouterDecembre extends JFrame implements ActionListener{
	/**
	 * Attributs privés de la classe PageAjouterDecembre
	 */
	//Attributs privés
	//Panel
	private JPanel panelPageAjouterDecembre;
	...
	public PageAjouterDecembre() {
	    ...
	    /**
	     * Instanciation de mes panels "panelPageAjouterDecembre" et "panelMessage"
	     */
	    //Instanciation des panels
	    this.panelPageAjouterDecembre = new JPanel();
	    this.panelMessage = new JPanel();
	    this.panelChamps = new JPanel();
	    this.panelBouton = new JPanel();

	    /**
	     * Mise en place des background des panels "panelPageAjouterDecembre" et "panelMessage"
	     */
	    //Background des panels
	    this.panelPageAjouterDecembre.setBackground(Color.white);
	    this.panelMessage.setBackground(Color.black);
	    
	    /**
	     * Mise en place des dispositions des panels "panelPageAjouterDecembre" et "panelMessage"
	     */
	    //Disposition des panels
	    this.panelPageAjouterDecembre.setLayout(new BorderLayout());
	    ...
	    this.panelPageAjouterDecembre.add(panelMessage, BorderLayout.NORTH);
	    this.panelPageAjouterDecembre.add(panelChamps, BorderLayout.CENTER);
	    this.panelPageAjouterDecembre.add(panelBouton, BorderLayout.SOUTH);
	    ...
	    //Toujours à la fin
  		...
  		this.getContentPane().add(panelPageAjouterDecembre);
  		this.setVisible(true);
	}
	
	public JPanel getMonPanelPageAjouterDecembre() {
    	return panelPageAjouterDecembre;
    }
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnValider) {
            ...
            boolean rep = Modele.AjouterAffectationDecembre(uneDateDebut, uneDateFin, uneAffectation);
            if(rep) {
