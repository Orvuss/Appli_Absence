...
/**
 * Classe PageAjouterNovembre
 * @author ldatchi
 *
 */
public class PageAjouterNovembre extends JFrame implements ActionListener{
	/**
	 * Attributs privés de la classe PageAjouterNovembre
	 */
	//Attributs privés
	//Panel
	private JPanel panelPageAjouterNovembre;
	...
	public PageAjouterNovembre() {
	    ...
	    /**
	     * Instanciation de mes panels "panelPageAjouterNovembre" et "panelMessage"
	     */
	    //Instanciation des panels
	    this.panelPageAjouterNovembre = new JPanel();
	    this.panelMessage = new JPanel();
	    this.panelChamps = new JPanel();
	    this.panelBouton = new JPanel();

	    /**
	     * Mise en place des background des panels "panelPageAjouterNovembre" et "panelMessage"
	     */
	    //Background des panels
	    this.panelPageAjouterNovembre.setBackground(Color.white);
	    this.panelMessage.setBackground(Color.black);
	    
	    /**
	     * Mise en place des dispositions des panels "panelPageAjouterNovembre" et "panelMessage"
	     */
	    //Disposition des panels
	    this.panelPageAjouterNovembre.setLayout(new BorderLayout());
	    ...
	    this.panelPageAjouterNovembre.add(panelMessage, BorderLayout.NORTH);
	    this.panelPageAjouterNovembre.add(panelChamps, BorderLayout.CENTER);
	    this.panelPageAjouterNovembre.add(panelBouton, BorderLayout.SOUTH);
	    ...
	    //Toujours à la fin
  		...
  		this.getContentPane().add(panelPageAjouterNovembre);
  		this.setVisible(true);
	}
	
	public JPanel getMonPanelPageAjouterNovembre() {
    	return panelPageAjouterNovembre;
    }
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnValider) {
            java.sql.Date uneDateDebut = (java.sql.Date) PageAjouterNovembre.this.datePicker1.getModel().getValue();
            java.sql.Date uneDateFin = (java.sql.Date) PageAjouterNovembre.this.datePicker2.getModel().getValue();
            ...
            boolean rep = Modele.AjouterAffectationNovembre(uneDateDebut, uneDateFin, uneAffectation, uneAutreAbsence);
            if(rep) {
