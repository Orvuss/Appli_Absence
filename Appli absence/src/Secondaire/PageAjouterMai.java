...
/**
 * Classe PageAjouterMai
 * @author ldatchi
 *
 */
public class PageAjouterMai extends JFrame implements ActionListener{
	/**
	 * Attributs privés de la classe PageAjouterMai
	 */
	//Attributs privés
	//Panel
	private JPanel panelPageAjouterMai;
	...
	public PageAjouterMai() {
	    ...
	    /**
	     * Instanciation de mes panels "panelPageAjouterMai" et "panelMessage"
	     */
	    //Instanciation des panels
	    this.panelPageAjouterMai = new JPanel();
	    this.panelMessage = new JPanel();
	    this.panelChamps = new JPanel();
	    this.panelBouton = new JPanel();

	    /**
	     * Mise en place des background des panels "panelPageAjouterMai" et "panelMessage"
	     */
	    //Background des panels
	    this.panelPageAjouterMai.setBackground(Color.white);
	    this.panelMessage.setBackground(Color.black);
	    
	    /**
	     * Mise en place des dispositions des panels "panelPageAjouterMai" et "panelMessage"
	     */
	    //Disposition des panels
	    this.panelPageAjouterMai.setLayout(new BorderLayout());
	    ...
	    this.panelPageAjouterMai.add(panelMessage, BorderLayout.NORTH);
	    this.panelPageAjouterMai.add(panelChamps, BorderLayout.CENTER);
	    this.panelPageAjouterMai.add(panelBouton, BorderLayout.SOUTH);
	    ...
	    //Toujours à la fin
  		...
  		this.getContentPane().add(panelPageAjouterMai);
  		this.setVisible(true);
	}
	
	public JPanel getMonPanelPageAjouterMai() {
    	return panelPageAjouterMai;
    }
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnValider) {
            java.sql.Date uneDateDebut = (java.sql.Date) PageAjouterMai.this.datePicker1.getModel().getValue();
            java.sql.Date uneDateFin = (java.sql.Date) PageAjouterMai.this.datePicker2.getModel().getValue();
            ...
            boolean rep = Modele.AjouterAffectationMai(uneDateDebut, uneDateFin, uneAffectation, uneAutreAbsence);
            if(rep) {
