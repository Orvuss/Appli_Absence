...
/**
 * Classe PageSupprimerJuin
 * @author ldatchi
 *
 */
public class PageSupprimerJuin extends JFrame implements ActionListener{
	/**
	 * Attributs privés de la classe PageSupprimerJuin
	 */
	//Attributs privés
	//Panel
	private JPanel panelPageSupprimerJuin;
	...
	//Constructeur
	public PageSupprimerJuin(ArrayList<Juin> listeDateDebutJuin) {
		//Configuration
		/**
	    ...
	    /**
	     * Instanciation de mes panels "panelPageSupprimerJuin" et "panelMessage"
	     */
	    //Instanciation des panels
	    this.panelPageSupprimerJuin = new JPanel();
	    this.panelMessage = new JPanel();
	    this.panelChamps = new JPanel();
	    this.panelBouton = new JPanel();

	    /**
	     * Mise en place des background des panels "panelPageSupprimerJuin" et "panelMessage"
	     */
	    //Background des panels
	    this.panelPageSupprimerJuin.setBackground(Color.white);
	    this.panelMessage.setBackground(Color.black);
	    
	    /**
	     * Mise en place des dispositions des panels "panelPageSupprimerJuin" et "panelMessage"
	     */
	    //Disposition des panels
	    this.panelPageSupprimerJuin.setLayout(new BorderLayout());
	    ...
	    for (Juin monJuin: listeDateDebutJuin) {
	    	this.jcbDate.addItem(monJuin.getDateDebutJ());
	    }
	    ...
	    this.panelPageSupprimerJuin.add(panelMessage, BorderLayout.NORTH);
	    this.panelPageSupprimerJuin.add(panelChamps, BorderLayout.CENTER);
	    this.panelPageSupprimerJuin.add(panelBouton, BorderLayout.SOUTH);
	    ...
	    //Toujours à la fin
  		...
  		this.getContentPane().add(panelPageSupprimerJuin);
  		this.setVisible(true);
	}
	
	public JPanel getMonPanelPageSupprimerJuin() {
    	return panelPageSupprimerJuin;
    }
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnValider) {
            ...
            if(Modele.suppressionAffectationJuin(dateDebut)) {
