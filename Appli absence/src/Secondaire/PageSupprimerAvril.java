...
/**
 * Classe PageSupprimerAvril
 * @author ldatchi
 *
 */
public class PageSupprimerAvril extends JFrame implements ActionListener{
	/**
	 * Attributs privés de la classe PageSupprimerAvril
	 */
	//Attributs privés
	//Panel
	private JPanel panelPageSupprimerAvril;
	...
	//Constructeur
	public PageSupprimerAvril(ArrayList<Avril> listeDateDebutAvril) {
		//Configuration
		/**
	    ...
	    /**
	     * Instanciation de mes panels "panelPageSupprimerAvril" et "panelMessage"
	     */
	    //Instanciation des panels
	    this.panelPageSupprimerAvril = new JPanel();
	    this.panelMessage = new JPanel();
	    this.panelChamps = new JPanel();
	    this.panelBouton = new JPanel();

	    /**
	     * Mise en place des background des panels "panelPageSupprimerAvril" et "panelMessage"
	     */
	    //Background des panels
	    this.panelPageSupprimerAvril.setBackground(Color.white);
	    this.panelMessage.setBackground(Color.black);
	    
	    /**
	     * Mise en place des dispositions des panels "panelPageSupprimerAvril" et "panelMessage"
	     */
	    //Disposition des panels
	    this.panelPageSupprimerAvril.setLayout(new BorderLayout());
	    ...
	    for (Avril monAvril: listeDateDebutAvril) {
	    	this.jcbDate.addItem(monAvril.getDateDebutA());
	    }
	    ...
	    this.panelPageSupprimerAvril.add(panelMessage, BorderLayout.NORTH);
	    this.panelPageSupprimerAvril.add(panelChamps, BorderLayout.CENTER);
	    this.panelPageSupprimerAvril.add(panelBouton, BorderLayout.SOUTH);
	    ...
	    //Toujours à la fin
  		...
  		this.getContentPane().add(panelPageSupprimerAvril);
  		this.setVisible(true);
	}
	
	public JPanel getMonPanelPageSupprimerAvril() {
    	return panelPageSupprimerAvril;
    }
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnValider) {
            ...
            if(Modele.suppressionAffectationAvril(dateDebut)) {
