...
/**
 * Classe PageAjouterSeptembre
 * @author ldatchi
 *
 */
public class PageAjouterSeptembre extends JFrame implements ActionListener{
	/**
	 * Attributs privés de la classe PageAjouterSeptembre
	 */
	//Attributs privés
	//Panel
	private JPanel panelPageAjouterSeptembre;
	...
	public PageAjouterSeptembre() {
	    ...
	    /**
	     * Instanciation de mes panels "panelPageAjouterSeptembre" et "panelMessage"
	     */
	    //Instanciation des panels
	    this.panelPageAjouterSeptembre = new JPanel();
	    this.panelMessage = new JPanel();
	    this.panelChamps = new JPanel();
	    this.panelBouton = new JPanel();

	    /**
	     * Mise en place des background des panels "panelPageAjouterSeptembre" et "panelMessage"
	     */
	    //Background des panels
	    this.panelPageAjouterSeptembre.setBackground(Color.white);
	    this.panelMessage.setBackground(Color.black);
	    
	    /**
	     * Mise en place des dispositions des panels "panelPageAjouterSeptembre" et "panelMessage"
	     */
	    //Disposition des panels
	    this.panelPageAjouterSeptembre.setLayout(new BorderLayout());
	    ...
	    this.panelPageAjouterSeptembre.add(panelMessage, BorderLayout.NORTH);
	    this.panelPageAjouterSeptembre.add(panelChamps, BorderLayout.CENTER);
	    this.panelPageAjouterSeptembre.add(panelBouton, BorderLayout.SOUTH);
	    ...
	    //Toujours à la fin
  		...
  		this.getContentPane().add(panelPageAjouterSeptembre);
  		this.setVisible(true);
	}
	
	public JPanel getMonPanelPageAjouterSeptembre() {
    	return panelPageAjouterSeptembre;
    }
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnValider) {
            java.sql.Date uneDateDebut = (java.sql.Date) PageAjouterSeptembre.this.datePicker1.getModel().getValue();
            java.sql.Date uneDateFin = (java.sql.Date) PageAjouterSeptembre.this.datePicker2.getModel().getValue();
            ...
            boolean rep = Modele.AjouterAffectationSeptembre(uneDateDebut, uneDateFin, uneAffectation, uneAutreAbsence);
            if(rep) {
