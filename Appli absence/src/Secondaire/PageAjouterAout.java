...
/**
 * Classe PageAjouterAout
 * @author ldatchi
 *
 */
public class PageAjouterAout extends JFrame implements ActionListener{
	/**
	 * Attributs privés de la classe PageAjouterAout
	 */
	//Attributs privés
	//Panel
	private JPanel panelPageAjouterAout;
	...
	public PageAjouterAout() {
	    ...
	    /**
	     * Instanciation de mes panels "panelPageAjouterAout" et "panelMessage"
	     */
	    //Instanciation des panels
	    this.panelPageAjouterAout = new JPanel();
	    this.panelMessage = new JPanel();
	    this.panelChamps = new JPanel();
	    this.panelBouton = new JPanel();

	    /**
	     * Mise en place des background des panels "panelPageAjouterAout" et "panelMessage"
	     */
	    //Background des panels
	    this.panelPageAjouterAout.setBackground(Color.white);
	    this.panelMessage.setBackground(Color.black);
	    
	    /**
	     * Mise en place des dispositions des panels "panelPageAjouterAout" et "panelMessage"
	     */
	    //Disposition des panels
	    this.panelPageAjouterAout.setLayout(new BorderLayout());
	    ...
	    this.panelPageAjouterAout.add(panelMessage, BorderLayout.NORTH);
	    this.panelPageAjouterAout.add(panelChamps, BorderLayout.CENTER);
	    this.panelPageAjouterAout.add(panelBouton, BorderLayout.SOUTH);
	    ...
	    //Toujours à la fin
  		...
  		this.getContentPane().add(panelPageAjouterAout);
  		this.setVisible(true);
	}
	
	public JPanel getMonPanelPageAjouterAout() {
    	return panelPageAjouterAout;
    }
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnValider) {
            java.sql.Date uneDateDebut = (java.sql.Date) PageAjouterAout.this.datePicker1.getModel().getValue();
            java.sql.Date uneDateFin = (java.sql.Date) PageAjouterAout.this.datePicker2.getModel().getValue();
            ...
            boolean rep = Modele.AjouterAffectationAout(uneDateDebut, uneDateFin, uneAffectation, uneAutreAbsence);
            if(rep) {
