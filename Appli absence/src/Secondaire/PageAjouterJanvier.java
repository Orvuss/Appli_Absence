...
/**
 * Classe PageAjouterJanvier
 * @author ldatchi
 *
 */
public class PageAjouterJanvier extends JFrame implements ActionListener{
	/**
	 * Attributs privés de la classe PageAjouterJanvier
	 */
	//Attributs privés
	//Panel
	private JPanel panelPageAjouterJanvier;
	...
	public PageAjouterJanvier() {
	    ...
	    /**
	     * Instanciation de mes panels "panelPageAjouterJanvier" et "panelMessage"
	     */
	    //Instanciation des panels
	    this.panelPageAjouterJanvier = new JPanel();
	    this.panelMessage = new JPanel();
	    this.panelChamps = new JPanel();
	    this.panelBouton = new JPanel();

	    /**
	     * Mise en place des background des panels "panelPageAjouterJanvier" et "panelMessage"
	     */
	    //Background des panels
	    this.panelPageAjouterJanvier.setBackground(Color.white);
	    this.panelMessage.setBackground(Color.black);
	    
	    /**
	     * Mise en place des dispositions des panels "panelPageAjouterJanvier" et "panelMessage"
	     */
	    //Disposition des panels
	    this.panelPageAjouterJanvier.setLayout(new BorderLayout());
	    ...
	    this.panelPageAjouterJanvier.add(panelMessage, BorderLayout.NORTH);
	    this.panelPageAjouterJanvier.add(panelChamps, BorderLayout.CENTER);
	    this.panelPageAjouterJanvier.add(panelBouton, BorderLayout.SOUTH);
	    ...
	    //Toujours à la fin
  		...
  		this.getContentPane().add(panelPageAjouterJanvier);
  		this.setVisible(true);
	}
	
	public JPanel getMonPanelPageAjouterJanvier() {
    	return panelPageAjouterJanvier;
    }
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnValider) {
            java.sql.Date uneDateDebut = (java.sql.Date) PageAjouterJanvier.this.datePicker1.getModel().getValue();
            java.sql.Date uneDateFin = (java.sql.Date) PageAjouterJanvier.this.datePicker2.getModel().getValue();
            ...
            boolean rep = Modele.AjouterAffectationJanvier(uneDateDebut, uneDateFin, uneAffectation, uneAutreAbsence);
            if(rep) {
