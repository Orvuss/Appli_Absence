...
/**
 * Classe PageAjouterOctobre
 * @author ldatchi
 *
 */
public class PageAjouterOctobre extends JFrame implements ActionListener{
	/**
	 * Attributs privés de la classe PageAjouterOctobre
	 */
	//Attributs privés
	//Panel
	private JPanel panelPageAjouterOctobre;
	...
	public PageAjouterOctobre() {
	    ...
	    /**
	     * Instanciation de mes panels "panelPageAjouterOctobre" et "panelMessage"
	     */
	    //Instanciation des panels
	    this.panelPageAjouterOctobre = new JPanel();
	    this.panelMessage = new JPanel();
	    this.panelChamps = new JPanel();
	    this.panelBouton = new JPanel();

	    /**
	     * Mise en place des background des panels "panelPageAjouterOctobre" et "panelMessage"
	     */
	    //Background des panels
	    this.panelPageAjouterOctobre.setBackground(Color.white);
	    this.panelMessage.setBackground(Color.black);
	    
	    /**
	     * Mise en place des dispositions des panels "panelPageAjouterOctobre" et "panelMessage"
	     */
	    //Disposition des panels
	    this.panelPageAjouterOctobre.setLayout(new BorderLayout());
	    ...
	    this.panelPageAjouterOctobre.add(panelMessage, BorderLayout.NORTH);
	    this.panelPageAjouterOctobre.add(panelChamps, BorderLayout.CENTER);
	    this.panelPageAjouterOctobre.add(panelBouton, BorderLayout.SOUTH);
	    ...
	    //Toujours à la fin
  		...
  		this.getContentPane().add(panelPageAjouterOctobre);
  		this.setVisible(true);
	}
	
	public JPanel getMonPanelPageAjouterOtcobre() {
    	return panelPageAjouterOctobre;
    }
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnValider) {
            java.sql.Date uneDateDebut = (java.sql.Date) PageAjouterOctobre.this.datePicker1.getModel().getValue();
            java.sql.Date uneDateFin = (java.sql.Date) PageAjouterOctobre.this.datePicker2.getModel().getValue();
            ...
            boolean rep = Modele.AjouterAffectationOctobre(uneDateDebut, uneDateFin, uneAffectation, uneAutreAbsence);
            if(rep) {
