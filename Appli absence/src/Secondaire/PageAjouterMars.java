...
/**
 * Classe PageAjouterMars
 * @author ldatchi
 *
 */
public class PageAjouterMars extends JFrame implements ActionListener{
	/**
	 * Attributs privés de la classe PageAjouterMars
	 */
	//Attributs privés
	//Panel
	private JPanel panelPageAjouterMars;
	...
	public PageAjouterMars() {
	    ...
	    /**
	     * Instanciation de mes panels "panelPageAjouterMars" et "panelMessage"
	     */
	    //Instanciation des panels
	    this.panelPageAjouterMars = new JPanel();
	    this.panelMessage = new JPanel();
	    this.panelChamps = new JPanel();
	    this.panelBouton = new JPanel();

	    /**
	     * Mise en place des background des panels "panelPageAjouterMars" et "panelMessage"
	     */
	    //Background des panels
	    this.panelPageAjouterMars.setBackground(Color.white);
	    this.panelMessage.setBackground(Color.black);
	    
	    /**
	     * Mise en place des dispositions des panels "panelPageAjouterMars" et "panelMessage"
	     */
	    //Disposition des panels
	    this.panelPageAjouterMars.setLayout(new BorderLayout());
	    ...
	    this.panelPageAjouterMars.add(panelMessage, BorderLayout.NORTH);
	    this.panelPageAjouterMars.add(panelChamps, BorderLayout.CENTER);
	    this.panelPageAjouterMars.add(panelBouton, BorderLayout.SOUTH);
	    ...
	    //Toujours à la fin
  		...
  		this.getContentPane().add(panelPageAjouterMars);
  		this.setVisible(true);
	}
	
	public JPanel getMonPanelPageAjouterMars() {
    	return panelPageAjouterMars;
    }
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnValider) {
            java.sql.Date uneDateDebut = (java.sql.Date) PageAjouterMars.this.datePicker1.getModel().getValue();
            java.sql.Date uneDateFin = (java.sql.Date) PageAjouterMars.this.datePicker2.getModel().getValue();
            ...
            boolean rep = Modele.AjouterAffectationMars(uneDateDebut, uneDateFin, uneAffectation, uneAutreAbsence);
            if(rep) {
