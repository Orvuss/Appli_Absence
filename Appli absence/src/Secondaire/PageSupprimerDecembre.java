...
/**
 * Classe PageSupprimerDecembre
 * @author ldatchi
 *
 */
public class PageSupprimerDecembre extends JFrame implements ActionListener{
	/**
	 * Attributs privés de la classe PageSupprimerDecembre
	 */
	//Attributs privés
	//Panel
	private JPanel panelPageSupprimerDecembre;
	...
	//Constructeur
	public PageSupprimerDecembre(ArrayList<Decembre> listeDateDebutDecembre) {
		//Configuration
		/**
	    ...
	    /**
	     * Instanciation de mes panels "panelPageSupprimerDecembre" et "panelMessage"
	     */
	    //Instanciation des panels
	    this.panelPageSupprimerDecembre = new JPanel();
	    this.panelMessage = new JPanel();
	    this.panelChamps = new JPanel();
	    this.panelBouton = new JPanel();

	    /**
	     * Mise en place des background des panels "panelPageSupprimerDecembre" et "panelMessage"
	     */
	    //Background des panels
	    this.panelPageSupprimerDecembre.setBackground(Color.white);
	    this.panelMessage.setBackground(Color.black);
	    
	    /**
	     * Mise en place des dispositions des panels "panelPageSupprimerDecembre" et "panelMessage"
	     */
	    //Disposition des panels
	    this.panelPageSupprimerDecembre.setLayout(new BorderLayout());
	    ...
	    for (Decembre monDecembre: listeDateDebutDecembre){
	    	this.jcbDate.addItem(monDecembre.getDateDebutD());
	    }
	    ...
	    this.panelPageSupprimerDecembre.add(panelMessage, BorderLayout.NORTH);
	    this.panelPageSupprimerDecembre.add(panelChamps, BorderLayout.CENTER);
	    this.panelPageSupprimerDecembre.add(panelBouton, BorderLayout.SOUTH);
	    ...
	    //Toujours à la fin
  		...
  		this.getContentPane().add(panelPageSupprimerDecembre);
  		this.setVisible(true);
	}
	
	public JPanel getMonPanelPageSupprimerDecembre() {
    	return panelPageSupprimerDecembre;
    }
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnValider) {
            ...
            if(Modele.suppressionAffectationDecembre(dateDebut)) {
