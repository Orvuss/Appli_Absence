...
/**
 * Classe PageAjouterFevrier
 * @author ldatchi
 *
 */
public class PageAjouterFevrier extends JFrame implements ActionListener{
	/**
	 * Attributs privés de la classe PageAjouterFevrier
	 */
	//Attributs privés
	//Panel
	private JPanel panelPageAjouterFevrier;
	...
	public PageAjouterFevrier() {
	    ...
	    /**
	     * Instanciation de mes panels "panelPageAjouterFevrier" et "panelMessage"
	     */
	    //Instanciation des panels
	    this.panelPageAjouterFevrier = new JPanel();
	    this.panelMessage = new JPanel();
	    this.panelChamps = new JPanel();
	    this.panelBouton = new JPanel();

	    /**
	     * Mise en place des background des panels "panelPageAjouterFevrier" et "panelMessage"
	     */
	    //Background des panels
	    this.panelPageAjouterFevrier.setBackground(Color.white);
	    this.panelMessage.setBackground(Color.black);
	    
	    /**
	     * Mise en place des dispositions des panels "panelPageAjouterFevrier" et "panelMessage"
	     */
	    //Disposition des panels
	    this.panelPageAjouterFevrier.setLayout(new BorderLayout());
	    ...
	    this.panelPageAjouterFevrier.add(panelMessage, BorderLayout.NORTH);
	    this.panelPageAjouterFevrier.add(panelChamps, BorderLayout.CENTER);
	    this.panelPageAjouterFevrier.add(panelBouton, BorderLayout.SOUTH);
	    ...
	    //Toujours à la fin
  		...
  		this.getContentPane().add(panelPageAjouterFevrier);
  		this.setVisible(true);
	}
	
	public JPanel getMonPanelPageAjouterFevrier() {
    	return panelPageAjouterFevrier;
    }
