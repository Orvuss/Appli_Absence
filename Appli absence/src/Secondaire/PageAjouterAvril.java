...
/**
 * Classe PageAjouterAvril
 * @author ldatchi
 *
 */
public class PageAjouterAvril extends JFrame implements ActionListener{
	/**
	 * Attributs privés de la classe PageAjouterAvril
	 */
	//Attributs privés
	//Panel
	private JPanel panelPageAjouterAvril;
	...
	public PageAjouterAvril() {
	    ...
	    /**
	     * Instanciation de mes panels "panelPageAjouterAvril" et "panelMessage"
	     */
	    //Instanciation des panels
	    this.panelPageAjouterAvril = new JPanel();
	    this.panelMessage = new JPanel();
	    this.panelChamps = new JPanel();
	    this.panelBouton = new JPanel();

	    /**
	     * Mise en place des background des panels "panelPageAjouterAvril" et "panelMessage"
	     */
	    //Background des panels
	    this.panelPageAjouterAvril.setBackground(Color.white);
	    this.panelMessage.setBackground(Color.black);
	    
	    /**
	     * Mise en place des dispositions des panels "panelPageAjouterAvril" et "panelMessage"
	     */
	    //Disposition des panels
	    this.panelPageAjouterAvril.setLayout(new BorderLayout());
	    ...
	    this.panelPageAjouterAvril.add(panelMessage, BorderLayout.NORTH);
	    this.panelPageAjouterAvril.add(panelChamps, BorderLayout.CENTER);
	    this.panelPageAjouterAvril.add(panelBouton, BorderLayout.SOUTH);
	    ...
	    //Toujours à la fin
  		...
  		this.getContentPane().add(panelPageAjouterAvril);
  		this.setVisible(true);
	}
	
	public JPanel getMonPanelPageAjouterAvril() {
    	return panelPageAjouterAvril;
    }
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnValider) {
            java.sql.Date uneDateDebut = (java.sql.Date) PageAjouterAvril.this.datePicker1.getModel().getValue();
            java.sql.Date uneDateFin = (java.sql.Date) PageAjouterAvril.this.datePicker2.getModel().getValue();
            ...
            boolean rep = Modele.AjouterAffectationAvril(uneDateDebut, uneDateFin, uneAffectation, uneAutreAbsence);
            if(rep) {
