...
public class PageJanvier extends JPanel implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnSupprimer) {
			...
			listeDateDebutJanvier = Modele.afficherDateDebutJanvier();
			PageSupprimerJanvier maPageSupprimerJanvier = new PageSupprimerJanvier(listeDateDebutJanvier);
		}
